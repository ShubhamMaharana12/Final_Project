...
class FoodApp:
    ...
    def admin_reg(self):
        ...
        while True:
            ...
            if len(password) >= 8:
                ...
                print("Please Enter the Password of Minimum 8 Characters\n")
    ...
    def add_food_item(self, name, quantity, price, discount, stock):
        '''add food items to the list which is availble in the Your Restaurant'''
            ...
            if len(self.food) > 0:  # to check if list is empty or not
                ...
                while True:
                    ...
                    if Echoice == 1:
                        ...
                        new_qun = input("Enter New Quantity\n")
    ...
    def user_reg(self):  # using "u" to indicate user
        ...
        self.uname = input("Enter Your Full Name = \n")
        while True:
            uphone = input("Enter Your Mobile Number\n")
        ...
        while True:
            regex = r'\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b'
            uemail = input("Enter Your Email here= \n")
        ...
        while True:
            print("Password must Contain min 8 characters")
            upassword = input("Enter Your Password Here\n")
        ...
        self.address = input("Enter Your Full Address Here\n")
        self.user_details = {"NAME": self.uname, "Mobile": self.uphone, "EMAIL": self.uemail, "PASSWORD": self.upassword,
    ...
    def update_User_Profile(self, upassword):
        ...
        if self.user_details["PASSWORD"] == upassword:
            while True:
                ...
                if upchoice == '1':
                    print(f"Your Current Profile Name is{self.user_details['NAME']}")
                    newname = input("Enter new Name \n")
                    self.user_details['NAME'] = newname
                    print(" Name Updated")
                elif upchoice == '2':
                    print(f"Your Current Mobile Number is{self.user_details['PHONE']}")
                    while True:
                    ...
                    print(f"Your Current Email is{self.user_details['EMAIL']}")
                    while True:
                        regex = r'\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b'
                        newemail = input("Entrer Your Email  here= \n")
                    ...
                    print(f"Your Current Address is{self.user_details['ADDRESS']}")
                    newadd = input("Enter new Email \n")
                    self.user_details['ADDRESS'] = newadd
                    print("Address Updated")
                elif upchoice == '5':
                    print("Password must Contain min 8 characters")
                    while True:
                        newpass = input("Entr rnew Password \n")
                        if len(newpass) >= 8:
            ...
            print("Wrong Password entered. Please enter Valid Password To continue")
    ...
    def delete_kart_item(self, foodid):
        ...
        if len(self.foodkart) != 0:
            ...
            print('\nNo food Items Availble For  Delete')
...
def Driver_code():
    ...
    while True:
        ...
        print("Please Enter Your Selction from Below Options\n")
        print('1. ADMIN')
        print('2. USER')
        print('3. CLOSE\n')
        ...
        if Dinput == '1':
            while True:
                ...
                if Dinput2 == '1':
                    ...
                    print(obj.admin_login.__doc__)
                    email = input('ENTER YOUR REGISTRED EMAIL : \n')
                            ...
                            if X == '1':
                                ...
                                while True:
                                    ...
                                    if price.isnumeric() == True:
                                        ...
                                        print("Only numeric value will accepted")
                                while True:
                ...
                if uinput == '1':
                    ...
                    if obj.user_login(uemail, upassword):
                        while True:
                            ...
                            print('5. Back')
                            uinput2 = input("Enter Your Choice")
                            if uinput2 == '1':
                                while True:
                                    ...
                                    print('4. Show Kart')
                                    print('5. Back')
                                    uinput3 = input("Enter Your Choice\n")
                                    if uinput3 == '1':
                                        obj.view_food_item()
                                    elif uinput3 == '2':
                                        if len(obj.food) > 0:
                                            food_id = input("Enter food Id Seprated By comma ex: 1,2,3,4,4,4 \n")
                                            for i in food_id:
                                                if i.isnumeric() == True:
                                                    obj.add_food_kart(i)
                                                else:
